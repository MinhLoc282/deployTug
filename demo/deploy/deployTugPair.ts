...
export default async function (hre: HardhatRuntimeEnvironment) {
  console.log(`Running deploy script for the TugPair contract`);
  ...
  const artifact = await deployer.loadArtifact("TugPair");

  const args = [
    "0xE33e26A46d4d2A1E168B9838456b2f4F6b7F0823",
  ...
  if (process.env.NODE_ENV != "test") {
    ...
    const contractFullyQualifedName = "contracts/TugPairPyth.sol:TugPair";
